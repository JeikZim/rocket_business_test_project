...
function Question(props) {
    ...
    return (
        <article onClick={isOpened ? () => {} : onClickHandler} className={s.question}>
            <h3 onClick={isOpened ? onClickHandler : () => {} }>{props.title}</h3>
            ...
            <div className={s.corner}>
                <div onClick={onClickHandler} className={s.open_close_btn}>
