...
function SlideSwithButton(props) {
    ...
    const onClickHandler = () => props.isNext ? swiper.slideNext() : swiper.slidePrev()

    return (
        <button className={s.slider_switch_btn} onClick={onClickHandler}>
            { 
                props.isNext 
                ?  
                <NextSlideButton />
...
function NextSlideButton() {
    return (   
        <svg width="34" height="34" viewBox="0 0 34 34" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_23165_30)">
...
function PrevSlideButton() {
    return (
        <svg width="34" height="34" viewBox="0 0 34 34"  xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_23165_34)">
